// tslint:disable no-any no-let no-object-mutation no-empty ordered-imports
...
describe('execute', () => {
  ...
  describe('Time Coin', () => {
    ...
    const deploy = async () =>
      executeSetupScript(new ScriptBuilder().emitAppCall(timeCoinContract.hash, 'contractDeploy').build());
