...
export interface AccountJSON {
  ...
  readonly balances: readonly { readonly asset: string; readonly value: string }[];
...
export interface MapContractParameterJSON {
  readonly type: 'Map';
  readonly value: readonly (readonly [ContractParameterJSON, ContractParameterJSON])[];
}
...
export interface InvocationDataJSON {
  ...
  readonly migratedContractHashes: readonly (readonly [string, string])[];
  readonly voteUpdates: readonly [string, readonly string[]];
...
export type AssetNameJSON = string | readonly { readonly lang: string; readonly name: string }[];
