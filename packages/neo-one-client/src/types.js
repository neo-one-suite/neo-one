...
export type BasicAccount = BasicAccountJSON;
export type BasicBlock = BasicBlockJSON;
export type BasicTransaction = BasicTransactionJSON;
export type BasicInvocationResult = BasicInvocationResultJSON;
