...
export default [
  {
    ...
    scriptHash: '0xcef0c0fdcfe7838eff6ff104f9cdec2922297537',
    scriptHashBuffer: Buffer.from(
      '3775292229eccdf904f16fff8e83e7cffdc0f0ce',
      'hex',
    ),
    scriptHashUInt160: common.bufferToUInt160(
      Buffer.from('3775292229eccdf904f16fff8e83e7cffdc0f0ce', 'hex'),
    ),
  },
  {
    name: 'second',
    ...
    scriptHash: '0x5df31f6f59e6a4fbdd75103786bf73db1000b235',
    scriptHashBuffer: Buffer.from(
      '35b20010db73bf86371075ddfba4e6596f1ff35d',
      'hex',
    ),
    scriptHashUInt160: common.bufferToUInt160(
      Buffer.from('35b20010db73bf86371075ddfba4e6596f1ff35d', 'hex'),
    ),
  },
  {
    name: 'third',
    ...
    scriptHash: '0x33cb2a009fc95cfd4a325e357428153561e24798',
    scriptHashBuffer: Buffer.from(
      '9847e26135152874355e324afd5cc99f002acb33',
      'hex',
    ),
    scriptHashUInt160: common.bufferToUInt160(
      Buffer.from('9847e26135152874355e324afd5cc99f002acb33', 'hex'),
    ),
  },
];
