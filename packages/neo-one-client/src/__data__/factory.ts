...
const createReadSmartContractDefinition = (
  options: Partial<ReadSmartContractDefinition> = {},
): ReadSmartContractDefinition => ({
  address: keys[0].address,
  abi: createABI(),
  ...options,
...
const createStorageItem = (options: Partial<StorageItem> = {}): StorageItem => ({
  address: keys[0].address,
  key: data.buffers.a,
  value: data.buffers.b,
  ...options,
...
export const factory = {
  ...
  createReadSmartContractDefinition,
