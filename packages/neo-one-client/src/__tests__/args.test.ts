...
describe('arg assertions', () => {
  ...
  test('assertNullableString - pass', () => {
    const value = 'foo';

    expect(args.assertNullableString('value', value)).toEqual(value);
  });

  test('assertNullableString - undefined', () => {
    const value = undefined;

    expect(args.assertNullableString('value', value)).toEqual(value);
  });

  test('assertNullableString - non-string', () => {
    const value = 0;

    expect(() => args.assertNullableString('value', value)).toThrowErrorMatchingSnapshot();
  });
  ...
  test('assertReadSmartContractDefinition - valid', () => {
    const value = data.readSmartContractDefinition.valid;

    expect(args.assertReadSmartContractDefinition('value', value)).toEqual(value);
  });

  test('assertReadSmartContractDefinition - undefined', () => {
    const value = undefined;

    expect(() => args.assertReadSmartContractDefinition('value', value)).toThrowErrorMatchingSnapshot();
  });

  test('assertReadSmartContractDefinition - non object', () => {
    const value = true;

    expect(() => args.assertReadSmartContractDefinition('value', value)).toThrowErrorMatchingSnapshot();
  });

  test('assertReadSmartContractDefinition - invalid', () => {
    const value = data.readSmartContractDefinition.invalid;
  ...
  test('assertUpdateAccountNameOptions - valid', () => {
    const value = data.updateAccountNameOptions.valid;
