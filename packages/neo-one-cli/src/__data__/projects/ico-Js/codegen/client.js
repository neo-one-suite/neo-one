/* @hash cf67ecdbed890bdd640f40dacfed0a42 */
// tslint:disable
/* eslint-disable */
import {
  addLocalKeysSync,
        ...
        addLocalKeysSync(
          [
            ...
            },
            {
              ...
              name: 'alfa',
              privateKey:
                'KyX5sPKRpAMb3XAFLUrHv7u1LxKkKFrpyJDgE4kceRX9FRJ4WRCQ',
            },
            {
              network: 'local',
              name: 'bravo',
              privateKey:
                'L5LfJc2Ngsxu8ZFMvnJbYJ1QdQCstzRXmKLybsFS1aQFURkJ5CHS',
            },
            {
              network: 'local',
              name: 'charlie',
            ...
            },
            {
              ...
              name: 'delta',
              privateKey:
                'KyVvngWhhfHiociMuwyLmGw8xTu9myKXRnvv5Fes9jDMa2Zyc6P9',
            },
            {
              network: 'local',
              name: 'echo',
              privateKey:
                'L37qr7PWqWmgjUPfRC9mS78GjRxgGi4azySCsLUBMAa5hMka2JEm',
            },
            {
              network: 'local',
              name: 'foxtrot',
              privateKey:
                'KwFf8gdSWxvC5Pp8AidNdF6mHqjH3CukyF3RnfwS5vzMQKLGTP13',
            },
            {
              network: 'local',
              name: 'golf',
              privateKey:
                'Kyn2BN3QuHGYgkt9qJgvwzY8yH4xgTUAKwnGhvU1w8Nh3JnivrAr',
            },
            {
              network: 'local',
              name: 'hotel',
              privateKey:
                'L5UXfz1xyzDkghGwistNMCV8pbpU4fg14Ez9rfo1y4KgwiadnWX3',
            },
            {
              network: 'local',
              name: 'india',
              privateKey:
                'L5Yoq3X4ojx2FvZZxHbMcvT6var4LaXKHEpMYyyxw4jjhSUNJTRa',
            },
            {
              network: 'local',
              name: 'juliett',
              privateKey:
                'L1DWex8PtmQJH4GYK9YAuyzmotyL6anY937LxJF54iaALrTtxsD6',
            },
          ],
          localKeyStore,
        );
