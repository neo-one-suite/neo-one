    ...
    sb.emitHelper(
      ...
      sb.helpers.forLoop({
        ...
        each: () => {
          ...
          sb.emitOp(node, 'DUP');
          // [5, idx, idx, callable, idx, callable, size, ...arr]
          sb.emitPushInt(node, 5);
          // [idx + 5, idx, callable, idx, callable, size, ...arr]
          sb.emitOp(node, 'ADD');
          // [val, idx, callable, idx, callable, size, ...arr]
          sb.emitOp(node, 'ROLL');
          // [2, val, idx, callable, idx, callable, size, ...arr]
