...
export class SetStorageIterator extends BuiltinInstanceMemberCall {
  ...
  public emitCall(
    ...
    // [val]
    sb.emitHelper(node, options, sb.helpers.createKeyIterableIteratorStructuredStorage({ type: Types.SetStorage }));
  }
}
