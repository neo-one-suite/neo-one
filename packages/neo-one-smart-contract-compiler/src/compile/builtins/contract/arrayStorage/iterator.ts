...
export class ArrayStorageIterator extends BuiltinInstanceMemberCall {
  ...
  public emitCall(
    ...
    // [val]
    sb.emitHelper(node, options, sb.helpers.createValIterableIteratorStructuredStorage({ type: Types.ArrayStorage }));
  }
}
