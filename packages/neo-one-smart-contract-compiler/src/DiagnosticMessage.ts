export enum DiagnosticMessage {
  ...
  InvalidContractType = 'Invalid SmartContract type. See <insert_url> for valid parameter and return types.',
  InvalidContractStorageType = 'Invalid SmartContract storage type. See <insert_url> for valid storage types.',
  ...
  InvalidContractMethodConstantNative = 'SmartContract methods marked with @send, @receive or @claim cannot be @constant.',
